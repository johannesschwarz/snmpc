...
struct WheelDynBicycleProperties
{
    WheelDynBicycleProperties()
    {
        mass = 1350; //1196.0; //1124.0;
        b    = 1.4; //1.168;  //1.35;
        a    = 1.4; //1.73;   //1.55;
        Iz   = mass * a * b;
        r_f  = 0.31;
...
class WheelDynBicycle
{
public:
    WheelDynBicycle(const WheelDynBicycleProperties &props);
    WheelDynBicycle();
    ~WheelDynBicycle(){}
