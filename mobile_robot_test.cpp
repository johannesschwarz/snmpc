...
int main(int argc, char **argv)
{
    ...
    Function ode_rhs = mobile_robot.getDynamics();  // get the RHS of the robot ODE
    ...
    polympc::nmpf<MobileRobot, Path, dimx, dimu, n_segments, poly_order> controller(tf);  // nmpf object
