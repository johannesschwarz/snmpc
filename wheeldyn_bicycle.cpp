...
WheelDynBicycle::WheelDynBicycle(const WheelDynBicycleProperties &props)
{
...
WheelDynBicycle::WheelDynBicycle()
{
    /** model constants [DevBot2]*/
    double g    = 9.81;    // gravity acceleration

    /** car parameters */
    WheelDynBicycleProperties props; // default car properties
    double m    = props.mass;
    double b    = props.b;
    double a    = props.a;
    double Iz   = props.Iz;
